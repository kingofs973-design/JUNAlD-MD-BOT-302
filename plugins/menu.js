...
const menuCommand = {
    ...
    async handler(sock, message, args, context) {
        ...
        try {
            ...
            // Menu sequence:
            // 1) standalone rectangular video (not a circular/voice-note message)
            // 2) menu text (the old menu picture is removed)
            // 3) normal MP3 audio underneath
            ...
            sendInteractiveMessage(sock, chatId, {
                ...
                interactiveButtons: [
                    { name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '👥 WhatsApp Group', url: settings.whatsappGroup || 'https://whatsapp.com/channel/0029Vb7dmVQ6rsQt3kJY131f' }) },
                    { name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '💬 Telegram Group', url: settings.telegramGroup || 'https://t.me/Hamza302bot' }) },
                ],
